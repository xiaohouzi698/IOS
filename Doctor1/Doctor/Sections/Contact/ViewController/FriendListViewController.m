...
- (void)jumpToSubscribView{
    SubscribeViewController *subscribe = [[SubscribeViewController alloc] initWithNibName:@"SubscribeViewController" bundle:nil];
