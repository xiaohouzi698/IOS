...
#import "AFNetWork.h"
@interface PatientInfoCheckViewController ()<FSComboPickerViewDelegate>
{
    UIView *bgView;
...
@implementation PatientInfoCheckViewController
...
//    [self.view addSubview:searchbar];
    ...
    emotionalState.userInteractionEnabled = NO;
    ...
    speakThink.userInteractionEnabled = NO;
   ...
   appearanceActions.userInteractionEnabled = NO;
   ...
   cognitive.userInteractionEnabled = NO;
   ...
   insight.userInteractionEnabled = NO;
    ...
    cognitiveFunction.userInteractionEnabled = NO;
...
-(void)landClick
{
    ...
    NSString *getEmotionalState = emotionalState.text ;
    NSString *getSpeakThink = speakThink.text;
    NSString *getAppearanceActions = appearanceActions.text;
    NSString *getCognitive = cognitive.text;
    NSString *getInsight = insight.text;
    NSString *getCognitiveFunction = cognitiveFunction.text;
    
    
    
    AFNetWork *afNetWork = [[AFNetWork alloc] init];
    [afNetWork reach];
    [afNetWork getWithURL:@"http://115.159.159.35:3001/api/Patients" WithParmeters:@{@"emotionalState":getEmotionalState, @"speakThink":getSpeakThink,@"appearanceActions":getAppearanceActions, @"cognitive":getCognitive,@"insight":getInsight, @"cognitiveFunction":getCognitiveFunction}];
