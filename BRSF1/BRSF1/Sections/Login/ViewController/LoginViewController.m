...
-(void) landLogin
{
    ...
    else if (textFieldPassword.text.length <3)
    {
        ...
        //个人信息
        [patient setObject:textFieldName.text forKey:@"username"];
        [patient setObject:textFieldPassword.text forKey:@"password"];
        ...
        [afNetWork postWithURL:@"http://115.159.159.35:3001/api/Patients/login?" WithParmeters:@{@"username":getUsername, @"password":getPassword}];
