...
- (void)viewDidLoad {
    ...
    name=[patient objectForKey:@"username"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 1) {
        ...
        CreateRQCodeViewController *rqCodeViewController=[[CreateRQCodeViewController alloc] init];
        
        [rqCodeViewController setHidesBottomBarWhenPushed:YES];
        [self.navigationController pushViewController:rqCodeViewController animated:YES];    }
