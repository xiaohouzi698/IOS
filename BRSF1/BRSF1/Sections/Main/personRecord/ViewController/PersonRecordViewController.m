...
#import "FMDatabase.h"
#import "AddPersonRecordViewController.h"
#import "PersonRecordDetailViewController.h"
#import "FMDatabaseQueue.h"
@interface PersonRecordViewController ()

@end

@implementation PersonRecordViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[PersonRecordViewCell class] forCellReuseIdentifier:@"cell"];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *path = [document stringByAppendingPathComponent:@"PATIENT.sqlite"];
    self.paths = path;
...
//    PersonRecordDetailViewController *personRecordDetailViewController=[[PersonRecordDetailViewController alloc] init];
//    [personRecordDetailViewController setHidesBottomBarWhenPushed:YES];
//    [self.navigationController pushViewController:personRecordDetailViewController animated:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    PersonRecordViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
...
-(void)toAdd{
       ...
       [self.navigationController pushViewController:[[AddPersonRecordViewController alloc]init] animated:YES];
...
- (void)modifyDatabase
{
    ...
    if (indexPath == nil) {
        ...
        PersonRecordDetailViewController *editUser = [[PersonRecordDetailViewController alloc]init];
