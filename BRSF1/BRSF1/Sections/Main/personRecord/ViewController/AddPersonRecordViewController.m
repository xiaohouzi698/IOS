//
//  AddPersonRecordViewController.m
//  BRSF
//
...
@interface AddPersonRecordViewController ()<UITextViewDelegate,UINavigationControllerDelegate>

@end

@implementation AddPersonRecordViewController
...
BOOL res = [db executeUpdate:sql,_createtimeStr,_txtView.text];
        if (!res) {
